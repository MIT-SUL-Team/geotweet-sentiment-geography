#usage: python src/main_sentiment_aggregator.py --countries USA --text_path /home/sentiment/data-lake/twitter/processed/ --geo_path /home/sentiment/data-lake/twitter/geoinfo/
