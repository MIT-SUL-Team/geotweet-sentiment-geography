#usage: python3 src/main_sentiment_imputer.py 20200101 --dict_methods liwc emoji --emb_methods bert
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='/home/sentiment/data_lake/twitter/processed/', type=str, help='path to data')
